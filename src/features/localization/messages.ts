export const ENGLISH_MESSAGE_KEYS = [
  ...
  'Your synchronized balances, by account and currency.',
  'Add category',
...
export const UKRAINIAN_MESSAGES = {
  ...
  Today: 'Сьогодні',
  Yesterday: 'Вчора',
  'Merchant appearance': 'Вигляд продавця',
  'This icon will be used for all transactions from this merchant.':
    'Ця іконка використовуватиметься для всіх транзакцій цього продавця.',
  'Change icon': 'Змінити іконку',
  'Remove custom icon': 'Видалити власну іконку',
  'SVG only, maximum 64 KB.': 'Лише SVG, до 64 КБ.',
  ...
  Active: 'Активний',
  Account: 'Рахунок',
  'Account balances': 'Баланси рахунків',
  account: 'рахунок',
  Actions: 'Дії',
  Card: 'Картка',
  ...
  '{count} accounts': '{count} рахунків',
  'Balances are shown in their original currencies.':
    'Баланси відображено в початкових валютах.',
  'Choose one, combine several, or return to the full picture.':
  ...
  'Your synchronized balances, by account and currency.':
    'Ваші синхронізовані баланси за рахунками та валютами.',
  ...
  'Category analytics': 'Аналітика категорій',
  'Configured source types': 'Налаштовані типи',
  'Expense distribution': 'Розподіл витрат',
  'Income distribution': 'Розподіл доходів',
  'Largest expense category': 'Найбільша категорія витрат',
  'Loading analytics…': 'Завантаження аналітики…',
  'Total source types': 'Усього типів джерел',
  Category: 'Категорія',
  ...
  'No matching categories': 'Немає відповідних категорій',
  ...
  'Restore default widgets': 'Відновити стандартні віджети',
